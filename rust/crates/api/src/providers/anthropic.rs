//! Anthropic-compatible API protocol implementation.
//!
//! This module implements the Anthropic Messages API protocol for use with
//! third-party endpoints that are compatible with the Anthropic API format
//! (e.g. Baidu Qianfan, Huawei ModelArts). It is **not** an endorsement of
//! or affiliation with Anthropic's commercial services.
//!
//! Anvil itself does not use Anthropic models. This protocol layer exists
//! because many Chinese cloud providers expose DeepSeek and other models
//! through an Anthropic-compatible API gateway.
